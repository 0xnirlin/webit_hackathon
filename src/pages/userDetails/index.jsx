...
const index = () => {
    ...
    const {departure_airpot, arrival_airport, price, departure_time,departure_date} = router.query
  return (
    <div className='w-full h-screen p-12 mt-14 flex flex-row'>
        <div className='h-full w-[60%] rounded-lg p-5 border mr-10 shadow-xl'>
                    <MyForm departure_airport={departure_airpot} arrival_airport={arrival_airport} departure_time={departure_time}></MyForm>
        </div>
